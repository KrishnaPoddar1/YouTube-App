...
- Configure Tailwind
- Create All the Base Components and give it a structure to get a Skeleton/Framework as shown above
- Created the Head component to be same as the Youtube page.
- Created the Side Bar Component
- Created the ButtonList Component
- Made an API Call to get the video's from YouTube Live API
